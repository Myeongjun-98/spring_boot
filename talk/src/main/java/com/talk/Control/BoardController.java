...
public class BoardController {
	...
	// 수정
	@GetMapping("/update")
	public String boardUpdate(BoardDto boardDto, HttpSession httpSession) {
		return null;
	}
	
	// 수정 페이지
	@GetMapping("/updatePage")
	public String boardUpdate(@RequestParam("id") int id, HttpSession httpSession, Model model) {
	...
	public String commentDel(@RequestParam("id") int id, HttpSession httpSession) {
		return null;
	}
